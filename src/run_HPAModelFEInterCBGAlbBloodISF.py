...
import json
from methods.models import HPAModelFEInterCBGAlbBloodISF
from methods import day_len

# Define parameter config file path
config_file = 'configs/HPAModelFEInterCBGAlbBloodISF/test_parameters.json'
...
# Initialise model
dde_model = HPAModelFEInterCBGAlbBloodISF(parameters=parameters, times=times, num_days=num_days, days_to_keep=days_to_keep, step=step)
...
plt.savefig(f'figures/model_output/HPAModelFEInterCBGAlbBloodISF/test_sim.png')
